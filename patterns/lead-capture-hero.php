...
return [
	'title'       => __( 'Lead-capture hero', 'formspress' ),
	'description' => __( 'A full-width hero with a big title and a lead-capture form below.', 'formspress' ),
...
<div class="wp-block-cover alignfull" style="min-height:520px">
	...
	<div class="wp-block-cover__inner-container">
		...
		<div class="wp-block-group">
			...
			<h1 class="wp-block-heading has-text-align-center" style="font-size:3.5rem;line-height:1.1">' . esc_html__( 'Built for teams that move fast', 'formspress' ) . '</h1>
			<!-- /wp:heading -->

			<!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"1.125rem"}}} -->
			<p class="has-text-align-center" style="font-size:1.125rem">' . esc_html__( 'Sign up below and we\'ll be in touch within 24 hours.', 'formspress' ) . '</p>
			<!-- /wp:paragraph -->

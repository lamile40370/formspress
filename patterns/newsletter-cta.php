...
return [
	'title'       => __( 'Newsletter CTA', 'flowforms' ),
	'description' => __( 'A colored full-width section with a heading and a one-field newsletter form.', 'flowforms' ),
...
<div class="wp-block-group alignfull has-text-color has-background" style="color:#ffffff;background-color:#0f172a;padding-top:var(--wp--preset--spacing--80);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--50)">
	...
	<h2 class="wp-block-heading has-text-align-center" style="font-size:2.5rem">' . esc_html__( 'Join the newsletter', 'flowforms' ) . '</h2>
	<!-- /wp:heading -->

	<!-- wp:paragraph {"align":"center"} -->
	<p class="has-text-align-center">' . esc_html__( 'One short email every Friday. Unsubscribe anytime.', 'flowforms' ) . '</p>
	<!-- /wp:paragraph -->

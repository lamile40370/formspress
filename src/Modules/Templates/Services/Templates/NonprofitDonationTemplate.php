...
class NonprofitDonationTemplate extends AbstractTemplate {
	...
	public function get_label(): string       { return __( 'Non-profit donation', 'flowforms' ); }
	public function get_description(): string { return __( 'Hero image + donation pledge form. Amount selector, donor details, dedication.', 'flowforms' ); }
	...
	public function get_fields(): array {
		return [
			[ 'id' => 'amount',    'type' => 'radio',  'label' => __( 'Donation amount', 'flowforms' ), 'required' => true, 'options' => [ '$25', '$50', '$100', '$250', '$500' ] ],
			[ 'id' => 'name',      'type' => 'text',   'label' => __( 'Your name', 'flowforms' ),     'required' => true ],
			[ 'id' => 'email',     'type' => 'email',  'label' => __( 'Email', 'flowforms' ),         'required' => true ],
			[ 'id' => 'message',   'type' => 'textarea', 'label' => __( 'A message (optional)', 'flowforms' ) ],
		];
	}
	...
	public function get_block_markup(): ?string {
		...
		$inner = implode( "\n", [
			TB::image( TB::placeholder( '1200x500', 'be123c', 'ffffff' ), __( 'Our mission', 'flowforms' ), [ 'radius' => '14px' ] ),
			TB::heading( [
				'text' => __( 'Stand with us', 'flowforms' ),
				'level' => 2, 'size' => '32px', 'weight' => '800', 'color' => '#881337',
				'marginBottom' => '8px',
			] ),
			TB::description( [
				'text' => __( '100% of your gift goes to our programs. Every dollar funds direct impact.', 'flowforms' ),
				'color' => '#9f1239', 'size' => '15px', 'marginBottom' => '24px',
			] ),
			TB::field_radio(    [ 'fieldId' => 'amount',  'label' => __( 'Donation amount', 'flowforms' ), 'required' => true, 'options' => $amounts ] ),
			...
			TB::field_textarea( [ 'fieldId' => 'message', 'label' => __( 'A message (optional)', 'flowforms' ), 'rows' => 3, 'placeholder' => __( 'Tell us why you give…', 'flowforms' ) ] ),
			TB::submit_button(  [ 'text' => __( 'Pledge donation', 'flowforms' ), 'bg' => '#be123c', 'fg' => '#ffffff', 'full' => true ] ),
		] );
